...
namespace Shapes.Cutting
{
    ...
    {
        public static bool CheckSameMaterial(Figure figureBefore, Figure figureAfter)
        {
            return (IsFilmFigure(figureBefore) && IsFilmFigure(figureAfter)) ||
                   (IsPaperFigure(figureBefore) && IsPaperFigure(figureAfter)) ||
                   (IsPlasticFigure(figureBefore) && IsPlasticFigure(figureAfter));
        }
