namespace Items.List_of_items
{
    ...
    public class Sugar : Item
    {
        ...
        /// <summary>
        /// Unit calories of the sugar.
        /// </summary>
        private const double UnitCalories = 3.98;

        /// <summary>
        /// Create new item: sugar.
        /// </summary>
        /// <param name="weight">Weight of item.</param>
        /// <param name="unitPrice">Price per gram of product.</param>
        public Sugar(double weight, double unitPrice)
        {
            this.Name = "Water";
            this.Weight = weight;
        ...
        /// </summary>
        /// <returns>Information about sugar.</returns>
